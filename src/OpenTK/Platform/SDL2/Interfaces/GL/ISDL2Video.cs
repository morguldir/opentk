...
namespace OpenTK.Platform.SDL2.Interfaces
{
    ...
    internal partial interface ISDL2GLVideo
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="attr">the <see cref="Attribute"/> structure to query.</param>
        ...
        /// </summary>
        /// <param name="attr">the OpenGL attribute to set; see <see cref="ContextAttribute"/> for details</param>
